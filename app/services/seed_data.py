...
PL_ROW_MAPPINGS = [
    ...
    # EXPENSES (rows 13-41)
    {
        ...
        "pl_row": 13,
        "display_name": "Agent Fees / Commission",
    ...
    },
    {
        ...
        "pl_row": 19,
        "display_name": "Due Diligence / Reports",
        "transaction_type": "expense",
        "is_deductible": True,
        "default_source": "INV",
        "sort_order": 16
    ...
    },
    {
        ...
        "pl_row": 25,
        "display_name": "Insurance - Landlord",
        "transaction_type": "expense",
        "is_deductible": True,
        "default_source": "INV",
        "sort_order": 22
    ...
    # NON-P&L Categories (for tracking but not on P&L)
    {
        "category_code": "bond",
        "pl_row": None,
    ...
    },
    {
        ...
        "pl_row": None,
        "display_name": "Principal Repayment",
        "transaction_type": "excluded",
        "is_deductible": False,
        "default_source": "BS",
        "sort_order": 101
...
async def seed_pl_row_mappings(db: AsyncSession) -> int:
    ...
    for mapping_data in PL_ROW_MAPPINGS:
        ...
        if not existing:
            ...
            db.add(mapping)
            count += 1
            logger.info(f"Added P&L mapping: {mapping_data['category_code']} -> Row {mapping_data['pl_row']}")
        else:
            logger.debug(f"P&L mapping already exists: {mapping_data['category_code']}")
...
async def main():
    ...
    print("-" * 50)
    print(f"✅ Tax rules added: {results['tax_rules']}")
    print(f"✅ P&L row mappings added: {results['pl_row_mappings']}")
