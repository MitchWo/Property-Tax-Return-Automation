...
class FileHandler:
    ...
    async def save_upload_from_bytes(
        self, content: bytes, filename: str, tax_return_id: str
    ) -> Tuple[str, str, int, str]:
        """
        Save file content (bytes) to disk.

        Used when file content has already been read (e.g., for SSE streaming).
