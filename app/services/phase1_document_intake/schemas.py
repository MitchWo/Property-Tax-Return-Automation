"""Tool Use schemas for Claude API - Guaranteed JSON structure."""
...
DOCUMENT_CLASSIFICATION_TOOL = {
    ...
    "input_schema": {
        "type": "object",
        "required": ["document_type", "confidence", "reasoning", "address_verification", "key_identifiers"],
        "properties": {
            "document_type": {
                "type": "string",
                "enum": [
...
BANK_STATEMENT_EXTRACTION_TOOL = {
    ...
    "input_schema": {
        "type": "object",
        "required": ["account_info", "statement_period", "transactions", "summary"],
        "properties": {
            "account_info": {
                "type": "object",
                ...
                "properties": {
                    ...
                    "account_type": {
                        "type": "string",
                        "enum": ["transaction", "savings", "loan", "revolving_credit", "offset", "other"]
                    },
                    "is_joint_account": {"type": "boolean"},
                    "is_rental_dedicated": {"type": "boolean"}
                }
            },
            "statement_period": {
                "type": "object",
                    ...
                    "properties": {
                        ...
                        "categorization": {
                            ...
                            "properties": {
                                ...
                                "confidence": {"type": "number", "minimum": 0, "maximum": 1},
                                "pl_row": {"type": ["integer", "null"]},
                                "is_deductible": {"type": "boolean"},
                                "exclude_from_pl": {"type": "boolean"}
                            }
                        },
                        "special_handling": {
                            "type": "object",
                            "properties": {
                                "is_combined_bond_rent": {"type": "boolean"},
                                "suggested_bond_amount": {"type": ["number", "null"]},
                                "suggested_rent_amount": {"type": ["number", "null"]},
                                "is_loan_repayment_total": {"type": "boolean"},
                                "linked_loan_account": {"type": ["string", "null"]},
                                "is_offset_related": {"type": "boolean"}
                            }
                        },
                        "review_flags": {
                            "type": "object",
            ...
            "interest_analysis": {
                ...
                "properties": {
                    ...
                    "interest_transaction_count": {"type": "integer"},
                    "offset_account_detected": {"type": "boolean"},
                    "offset_notes": {"type": ["string", "null"]},
                    "monthly_breakdown": {
                        "type": "object",
            ...
            "summary": {
                "type": "object",
                "required": ["total_transactions", "total_credits", "total_debits"],
                "properties": {
                    "total_transactions": {"type": "integer"},
                    "total_credits": {"type": "number"},
                    "total_debits": {"type": "number"},
                    "net_movement": {"type": "number"},
                    "balance_validated": {"type": "boolean"},
                    "balance_variance": {"type": ["number", "null"]},
...
# Settlement Statement Extraction Tool (Year 1 Critical)
SETTLEMENT_STATEMENT_EXTRACTION_TOOL = {
    ...
    "input_schema": {
        "type": "object",
        "required": ["settlement_info", "financial_details", "fees_and_costs", "year1_tax_calculations"],
        "properties": {
            "settlement_info": {
                "type": "object",
                ...
                "properties": {
                    ...
                    "solicitor_firm": {"type": ["string", "null"]}
                }
            },
            "financial_details": {
                "type": "object",
                ...
                "properties": {
                    ...
                    "balance_due_on_settlement": {"type": ["number", "null"]}
                }
            },
            "apportionments": {
                "type": "object",
                "properties": {
                    "rates": {
                        "type": "object",
                        "properties": {
                            "settlement_apportionment": {"type": "number"},
                            "vendor_instalment": {"type": ["number", "null"]},
                            "vendor_credit": {"type": ["number", "null"]},
                            "direction": {
                                "type": "string",
                    ...
                    "body_corporate": {
                        ...
                        "properties": {
                            "adjustment_amount": {"type": ["number", "null"]},
                            "operating_portion": {"type": ["number", "null"]},
                            "reserve_portion": {"type": ["number", "null"]}
                        }
                    },
                    "resident_society": {
                        "type": "object",
                    ...
                    "insurance": {
                        ...
                        "properties": {
                            "adjustment_amount": {"type": ["number", "null"]},
                            "policy_transferred": {"type": "boolean"}
                        }
                    }
                }
            },
            ...
            "bank_contribution": {
                "type": "object",
                "properties": {
                    "mentioned_in_settlement": {"type": "boolean"},
                    "amount": {"type": ["number", "null"]},
                ...
                "properties": {
                    "rates_deductible": {
                        ...
                        "properties": {
                            ...
                            "vendor_instalment": {"type": ["number", "null"]},
                            "vendor_credit": {"type": ["number", "null"]},
                            "total_from_settlement": {"type": "number"},
                    ...
                    "legal_fees_deductible": {
                        ...
                        "properties": {
                            ...
                            "is_under_10k_threshold": {"type": "boolean"},
...
# P&L Row Mapping - Complete category to row mapping
PL_ROW_MAPPING = {
    # === INCOME ===
    "rental_income": {"row": 6, "type": "income", "description": "Rent received"},
    "other_rental_income": {"row": 7, "type": "income", "description": "Other rental income"},
    "bank_contribution": {"row": 8, "type": "income", "description": "Bank cashback/contribution - TAXABLE"},
    "water_rates_recovered": {"row": 9, "type": "income", "description": "Water recovered from tenant"},
    "insurance_recovered": {"row": 10, "type": "income", "description": "Insurance payouts"},
    "short_term_rental_income": {"row": 6, "type": "income", "description": "Airbnb/short-term rent"},

    # === EXPENSES ===
    "advertising": {"row": 12, "type": "expense", "description": "Tenant-finding ads ONLY (separate from agent fees)"},
    "agent_fees": {"row": 13, "type": "expense", "description": "Property management fees (GST inclusive)"},
    "letting_fee": {"row": 13, "type": "expense", "description": "Tenant finding fee"},
    "platform_fees": {"row": 13, "type": "expense", "description": "Airbnb/Bookabach platform fees"},
    ...
    "due_diligence": {"row": 18, "type": "expense", "description": "LIM, meth test, healthy homes, Valocity, Valuit"},
    "landlord_insurance": {"row": 24, "type": "expense", "description": "Landlord/rental insurance ONLY"},
    "interest_debit": {"row": 25, "type": "expense", "description": "After deductibility % applied"},
    "interest_expense": {"row": 25, "type": "expense", "description": "Alias for interest_debit"},
    ...
    "repairs_maintenance": {"row": 35, "type": "expense", "description": "Repairs and maintenance"},
    ...
    "other_property_costs": {"row": 37, "type": "expense", "description": "Other property costs"},
    "home_office": {"row": 37, "type": "expense", "description": "Home office costs (rental portion)"},
    "mileage": {"row": 37, "type": "expense", "description": "Travel to property (IRD rate $0.99/km)"},
    ...
    "ffe_contribution": {"row": None, "type": "excluded", "reason": "Capital contribution (short-term rental)"},
    ...
    "loan_repayment": {"row": None, "type": "excluded", "reason": "Capital repayment"},
    "interest_credit": {"row": None, "type": "excluded", "reason": "DO NOT subtract from interest debits"},
    "unknown": {"row": None, "type": "flagged", "reason": "Requires manual categorization"}
}


def get_pl_row(category: str) -> dict:
    """Get P&L row mapping for a category."""
    return PL_ROW_MAPPING.get(category, {"row": None, "type": "flagged", "reason": "Unknown category"})


def is_deductible(category: str) -> bool:
    """Check if a category is deductible."""
    mapping = PL_ROW_MAPPING.get(category)
    if not mapping:
        return False
    return mapping.get("type") == "expense" and mapping.get("row") is not None


def is_excluded(category: str) -> bool:
    """Check if a category should be excluded from P&L."""
    mapping = PL_ROW_MAPPING.get(category)
    if not mapping:
        return False
    return mapping.get("type") == "excluded"


# ============================================================================
# Additional Tool Use Schemas for All Financial Documents
# ============================================================================

# Generic Expense Document Extraction Tool (rates, water, insurance, invoices)
EXPENSE_DOCUMENT_EXTRACTION_TOOL = {
    ...
    "input_schema": {
        "type": "object",
        "required": ["document_info", "expense_details", "tax_treatment"],
        "properties": {
            "document_info": {
                "type": "object",
                "required": ["issuer", "document_date"],
                "properties": {
                    "issuer": {"type": "string", "description": "Company/council issuing the document"},
            ...
            "expense_details": {
                "type": "object",
                "required": ["total_amount", "gst_inclusive"],
                "properties": {
                    ...
                    "payment_status": {
                        "type": "string",
                        "enum": ["paid", "unpaid", "partial", "unknown"]
                    },
            ...
            "tax_treatment": {
                "type": "object",
                "required": ["suggested_category", "is_deductible", "pl_row"],
                "properties": {
                    "suggested_category": {
                        "type": "string",
                        "enum": [
                            "council_rates", "water_rates", "landlord_insurance",
                            "repairs_maintenance", "body_corporate_operating",
                            "body_corporate_reserve", "resident_society",
                            "agent_fees", "legal_fees", "accounting_fees",
                            "advertising", "other_property_costs", "personal_expense"
                        ]
                    },
                    "is_deductible": {"type": "boolean"},
                    "pl_row": {"type": ["integer", "null"]},
                    "deductible_amount": {"type": "number"},
                    "non_deductible_amount": {"type": ["number", "null"]},
                    "non_deductible_reason": {"type": ["string", "null"]},
                    "confidence": {"type": "number", "minimum": 0, "maximum": 1}
                }
            },
            "flags": {
...
# Body Corporate Extraction Tool (critical for operating vs reserve split)
BODY_CORPORATE_EXTRACTION_TOOL = {
    ...
    "input_schema": {
        "type": "object",
        "required": ["body_corporate_info", "levy_details", "tax_treatment"],
        "properties": {
            "body_corporate_info": {
                "type": "object",
                "required": ["bc_name"],
                "properties": {
                    ...
                    "unit_entitlement": {"type": ["number", "null"]},
                    "property_address": {"type": ["string", "null"]},
                    "levy_period": {"type": ["string", "null"]},
                    "period_start": {"type": ["string", "null"], "format": "date"},
                    "period_end": {"type": ["string", "null"], "format": "date"}
                }
            },
            "levy_details": {
                ...
                "properties": {
                    ...
                    "insurance_component": {"type": ["number", "null"]},
            ...
            "tax_treatment": {
                "type": "object",
                "required": ["deductible_total", "non_deductible_total"],
                "properties": {
                    "deductible_total": {
                        "type": "number",
                    ...
                    "operating_pl_row": {"type": "integer", "default": 15},
                    "confidence": {"type": "number", "minimum": 0, "maximum": 1},
                    "split_method": {
                        "type": "string",
                        "enum": ["explicit_breakdown", "percentage_estimate", "full_deductible", "requires_clarification"]
                    },
...
# Depreciation Schedule Extraction Tool
DEPRECIATION_SCHEDULE_EXTRACTION_TOOL = {
    ...
    "input_schema": {
        "type": "object",
        "required": ["property_info", "valuation_summary", "assets"],
        "properties": {
            "property_info": {
                "type": "object",
                ...
                "properties": {
                    ...
                    "valuation_provider": {"type": ["string", "null"]},
                    "report_number": {"type": ["string", "null"]},
                    "property_type": {
                        "type": "string",
                        "enum": ["residential", "commercial", "mixed", "new_build"]
                    },
            ...
            "valuation_summary": {
                "type": "object",
                "required": ["total_depreciable_value", "annual_depreciation"],
                "properties": {
                    ...
                    "depreciation_method": {
                        "type": "string",
                        "enum": ["diminishing_value", "straight_line"]
                    },
                    "chattels_value": {"type": ["number", "null"]},
            ...
            "assets": {
                ...
                "items": {
                    "type": "object",
                    "required": ["asset_name", "value", "rate", "annual_depreciation"],
                    "properties": {
                        "asset_name": {"type": "string"},
                        "asset_category": {
                            "type": "string",
                            "enum": ["building", "fit_out", "plant_equipment", "furniture", "appliances", "other"]
                        },
                        "value": {"type": "number"},
                        "rate": {"type": "number", "description": "Depreciation rate as percentage"},
                        "method": {"type": "string", "enum": ["DV", "SL"]},
                        "annual_depreciation": {"type": "number"},
            ...
            "year1_adjustments": {
                "type": "object",
                "properties": {
                    "is_partial_year": {"type": "boolean"},
                    "ownership_start_date": {"type": ["string", "null"], "format": "date"},
                    "days_owned": {"type": ["integer", "null"]},
                    "pro_rata_factor": {"type": ["number", "null"]},
                    "adjusted_depreciation": {"type": ["number", "null"]}
                },
                "description": "Pro-rata depreciation for partial year of ownership"
            },
            "tax_treatment": {
                "type": "object",
                "required": ["deductible_depreciation", "pl_row"],
                "properties": {
                    "deductible_depreciation": {"type": "number"},
                    "pl_row": {"type": "integer", "default": 17},
                    "confidence": {"type": "number", "minimum": 0, "maximum": 1}
                }
            }
        }
...
# Loan Statement Extraction Tool
LOAN_STATEMENT_EXTRACTION_TOOL = {
    ...
    "input_schema": {
        "type": "object",
        "required": ["loan_info", "statement_period", "interest_summary", "transactions"],
        "properties": {
            "loan_info": {
                "type": "object",
                "required": ["lender", "account_number"],
                "properties": {
                    "lender": {"type": "string"},
                    "account_number": {"type": "string"},
                    "loan_type": {
                        "type": "string",
                        "enum": ["table_loan", "revolving_credit", "interest_only", "offset", "fixed", "floating"]
                    },
                    "original_amount": {"type": ["number", "null"]},
                    "current_balance": {"type": "number"},
                    "interest_rate": {"type": ["number", "null"]},
                    "rate_type": {"type": "string", "enum": ["fixed", "floating", "mixed"]},
                    "property_secured": {"type": ["string", "null"]}
                }
            },
            "statement_period": {
                "type": "object",
            ...
            "interest_summary": {
                "type": "object",
                "required": ["total_interest_charged"],
                "properties": {
                    ...
                    "average_daily_rate": {"type": ["number", "null"]},
                    "interest_frequency": {
                        "type": "string",
            ...
            "principal_summary": {
                "type": "object",
                "properties": {
                    "total_principal_paid": {"type": "number"},
                    "principal_frequency": {"type": ["string", "null"]},
                    "is_interest_only": {"type": "boolean"}
                }
            },
            "transactions": {
                "type": "array",
                "items": {
                    ...
                    "properties": {
                        ...
                        "transaction_type": {
                            "type": "string",
                            "enum": ["interest_debit", "interest_credit", "principal", "fee", "drawdown", "repayment", "other"]
                        }
                    }
                }
            },
            "offset_account": {
                "type": "object",
                "properties": {
                    "is_offset": {"type": "boolean"},
                    "offset_balance": {"type": ["number", "null"]},
                    "interest_saved": {"type": ["number", "null"]},
                    "notes": {"type": ["string", "null"]}
                }
            },
            "tax_treatment": {
                "type": "object",
                "required": ["gross_interest_deductible"],
                "properties": {
                    ...
                    "net_deductible_interest": {"type": "number"},
                    "pl_row": {"type": "integer", "default": 25},
                    "principal_excluded": {
                        "type": "number",
...
# Property Manager Statement Extraction Tool
PROPERTY_MANAGER_STATEMENT_EXTRACTION_TOOL = {
    ...
    "input_schema": {
        "type": "object",
        "required": ["manager_info", "statement_period", "income", "expenses", "summary"],
        "properties": {
            "manager_info": {
                "type": "object",
            ...
            "summary": {
                "type": "object",
                "required": ["opening_balance", "closing_balance"],
                "properties": {
                    "opening_balance": {"type": "number"},
            ...
            "tax_treatment": {
                "type": "object",
                "properties": {
                    "rental_income_row_6": {"type": "number"},
                    "agent_fees_row_13": {"type": "number"},
                    "letting_fee_row_13": {"type": ["number", "null"]},
                    "advertising_row_12": {"type": ["number", "null"]},
                    "repairs_row_35": {"type": ["number", "null"]},
                    "confidence": {"type": "number", "minimum": 0, "maximum": 1}
                }
            },
            "extraction_metadata": {
                ...
                "properties": {
                    "pages_processed": {"type": "integer"},
                    "batch_number": {"type": ["integer", "null"]},
                    "total_batches": {"type": ["integer", "null"]},
                    "data_quality_score": {"type": "number", "minimum": 0, "maximum": 1}
                }
            }
        }
...
def get_extraction_tool_for_document_type(document_type: str) -> dict:
    ...
    TOOL_MAPPING = {
        "bank_statement": BANK_STATEMENT_EXTRACTION_TOOL,
        "loan_statement": LOAN_STATEMENT_EXTRACTION_TOOL,
        "settlement_statement": SETTLEMENT_STATEMENT_EXTRACTION_TOOL,
